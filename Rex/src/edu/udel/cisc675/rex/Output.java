...
public class Output {
	...
	/*
	 * For each problem, permutation of answers, from module RandomizeAnswers
	 */
	int[][] answerPerms;

	/*
	 * Constructs new instance of Output from given fields; only sets fields and
	 * does nothing else
	 */
	public Output(PrintStream out, char[] chars, int[] probStarts,
			int[] probStops, int[][] answerStarts, int[][] answerStops,
	...
	/*
	 * Prints a range of characters to out, starting at start, ending at stop-1
	 */
	...
	/*
	 * Prints the entire exam with permuted problems and permuted answers
	 */
	public void execute() {
